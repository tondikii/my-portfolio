    ...
    <div>
      <div className="h-screen w-full flex justify-center items-center">
        <div className="w-5/6 flex flex-col md:flex-row justify-between md:h-4/5 items-end">
          <div className="flex flex-col md:mb-32 w-full md:w-1/3">
      ...
      <div className="h-screen w-full flex flex-col justify-center items-center">
        <strong className="text-4xl font-lexend mb-4 md:mb-8">About me</strong>
        <div className="flex flex-col md:flex-row w-5/6 items-center">
          <Image
            src={SelfPhoto}
            alt="Self photo"
            className="mb-4 md:mb-0 w-1/2 md:w-1/4"
          />
